...
<!--	<link rel="stylesheet" href="-->{*iw_themepath file=$stylesheet type=css theme=IWxtec*}<!--" type="text/css" /> -->
...
<!--		<div id="themelogo" style="background:url(-->{*iw_themepath file=$logotip type=logo theme=IWxtec*}<!--) no-repeat top right;"> -->
