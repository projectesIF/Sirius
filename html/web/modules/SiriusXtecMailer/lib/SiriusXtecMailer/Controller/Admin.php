 ...
 */
class SiriusXtecMailer_Controller_Admin extends Zikula_AbstractController {

    public function main() {
        // security check
        if (!SecurityUtil::checkPermission('SiriusXtecMailer::', '::', ACCESS_EDIT)) {
        ...
        return $render->fetch('siriusxtecmailer_admin_main.tpl');
    }
    ...
    public function testconfig() {
        ...
        // create a new output object
        $view = Zikula_View::getInstance('SiriusXtecMailer', false);

        // Return the output that has been generated by this function
        return $view->fetch('siriusxtecmailer_admin_testconfig.tpl');
    }
