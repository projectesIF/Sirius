...
$ZConfig['System']['temp'] = $sirius['dir_root_sirius'].'/ztemp';       // location of temporary folder
$ZConfig['System']['datadir'] = $sirius['dir_root_sirius'].'/zfiles/userdata';     // location of site data files
...
// ----------------------------------------------------------------------
$ZConfig['DBInfo']['databases']['default']['host'] = $sirius['dbhost'];
$ZConfig['DBInfo']['databases']['default']['user'] = $sirius['dbuname'];
$ZConfig['DBInfo']['databases']['default']['password'] = $sirius['dbpass'];
$ZConfig['DBInfo']['databases']['default']['dbname'] = $sirius['dbname'];
